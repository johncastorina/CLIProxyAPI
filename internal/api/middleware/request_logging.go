...
// and uses the provided RequestLogger to record this data. When request logging is disabled,
// the middleware does not capture or persist conversation bodies.
